...
Mapear a operacao ponta a ponta para reduzir improviso, aumentar previsibilidade e permitir automacao.

## Fluxo macro

1. Captacao ou indicacao
2. Triagem inicial
3. Reuniao ou formulario de diagnostico
4. Proposta comercial
5. Contratacao e onboarding
6. Coleta documental
7. Analise tecnica
8. Estrategia juridica
9. Producao de documentos
10. Revisao final
11. Entrega e explicacao ao cliente
12. Follow-up e recorrencia

## Esteira aprovada

A versao aprovada para o blueprint estrategico organiza o fluxo em 10 etapas:
...
Essa esteira sera usada como base para produtos, agentes, templates, automacoes e metricas.

## Pontos de controle

- Qualificacao do cliente
- Conflito de interesses
- Adequacao da solucao
...
## Trilha Empresarial e Societaria 360
...
- [Plano de acao Empresarial e Societario 360](operacao/plano-acao-empresarial-societario-360.md)
...
- [Mensagem de entrega do diagnostico Empresarial e Societario 360](templates/comercial/mensagem-entrega-diagnostico-empresarial-societario-360.md)
- [Contrato de honorarios Empresarial e Societario 360](templates/contratos/contrato-honorarios-empresarial-societario-360.md)
- [Onboarding Empresarial e Societario 360](templates/operacao/onboarding-empresarial-societario-360.md)
